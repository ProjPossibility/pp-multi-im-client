// trying to add a hot key to for the sign on button here
// made on top of the working front page version with event handlers by abhishek
...
axsSkel.keyHandler = function(evt){
  ...
  /// from abhishek
	if (evt.shiftKey && evt.keyCode == 83) 
	{
		...
		if( String(evt.target.tagName).toLowerCase() == "textarea" && evt.target.className == 'uiImMessage' )
		{
